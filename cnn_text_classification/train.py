...
data_file = "{}jd_train.json".format(FLAGS.data_dir)
...
# Load data
print("Loading data...")
x_text, y, labels = data_helpers.load_data_and_labels(data_file,FLAGS.label_field)
...
with tf.Graph().as_default():
    ...
    with sess.as_default():
        ...
        checkpoint_prefix = os.path.join(checkpoint_dir, FLAGS.label_field +".model")
